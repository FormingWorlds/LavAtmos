"""
This code is a modified version of thermochem code: https://github.com/adelq/thermochem
...
class JanafPhase(object):
    ...
    def __init__(self, rawdata_text):
        ...
        try:
            ...
            self.rawdata = None
            print("Error parsing JANAF data file for %s. The raw data text is:" % self.description)
            return
        ...
        # Save T values from JANAF table (ADDED FOR LAVATMOS)
        self.T = self.rawdata['T'].dropna() 
        self.T = self.T[self.T > 1000] # Remove values below 1000 (avoids below interp. error)
